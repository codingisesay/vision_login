  ...
  <table class="table table-bordered">
    ...
    <tr>
        ...
        <td id="specificissuehighlight_tr"><select class="form-control" id="specificissuehighlight" name="specificissuehighlight" required>
            <option value="<?php echo $feedbackdata[0]['specific_issue_highlighted_by_students']; ?>"><?php echo $feedbackdata[0]['specific_issue_highlighted_by_students']; ?></option>
            <option value="Yes">Yes</option>
            <option value="No">No</option></select><br> <textarea class="form-control" rows="5" id="specificissuehighlightcomment" name="specificissuehighlightcomment" placeholder="Please Write Here" style="display: none;"><?php echo $feedbackdata[0]['issue_highlight_by_student_remark']; ?></textarea></td>
    </tr>
    <tr>
    ...
    <div class="form-check formcssradio" style="display:inline;">
      <label class="form-check-label">
        <input type="radio" class="form-check-input radiosize" name="TimeManagement" value="2" <?php echo ($time_managementRating == 3)?("checked"):("")?>> 3
      </label>
    </div>
    <div class="form-check formcssradio" style="display:inline;">
      <label class="form-check-label">
        <input type="radio" class="form-check-input radiosize" name="TimeManagement" value="2" <?php echo ($time_managementRating == 4)?("checked"):("")?>> 4
      </label>
    </div>
    <div class="form-check formcssradio" style="display:inline;">
      <label class="form-check-label">
        <input type="radio" class="form-check-input radiosize" name="TimeManagement" value="2" <?php echo ($time_managementRating == 5)?("checked"):("")?>> 5
      </label>
    ...
    <?php 
    $faculty_meet_your_expectationsRating = $feedbackdata[0]['faculty_meet_your_expectations'];
    
    ?>
        <td> <div class="form-check formcssradio"  style="display:inline;">
      <label class="form-check-label" for="radio1">
        <input type="radio" class="form-check-input radiosize" id="radio1" name="facultymeetyourexpectations" value="1" <?php echo ($faculty_meet_your_expectationsRating == 1)?("checked"):("");?>> 1
      </label>
    </div>
    <div class="form-check formcssradio" style="display:inline;">
      <label class="form-check-label" for="radio2">
        <input type="radio" class="form-check-input radiosize" id="radio2" name="facultymeetyourexpectations" value="2" <?php echo ($faculty_meet_your_expectationsRating == 2)?("checked"):("");?>> 2
      </label>
    </div>
    <div class="form-check formcssradio" style="display:inline;">
      <label class="form-check-label">
        <input type="radio" class="form-check-input radiosize" name="facultymeetyourexpectations" value="3" <?php echo ($faculty_meet_your_expectationsRating == 3)?("checked"):("");?>> 3
      </label>
    </div>
    <div class="form-check formcssradio" style="display:inline;">
      <label class="form-check-label">
        <input type="radio" class="form-check-input radiosize" name="facultymeetyourexpectations" value="4" <?php echo ($faculty_meet_your_expectationsRating == 4)?("checked"):("");?>> 4
      </label>
    </div>
    <div class="form-check formcssradio" style="display:inline;">
      <label class="form-check-label">
        <input type="radio" class="form-check-input radiosize" name="facultymeetyourexpectations" value="5" <?php echo ($faculty_meet_your_expectationsRating == 5)?("checked"):("");?>> 5
      </label>
    </div><textarea class="form-control" rows="5" id="facultymeetyourexpectationscomment" name="facultymeetyourexpectationscomment" placeholder="faculty meet your expectations" required><?php echo $feedbackdata[0]['faculty_meet_your_expectations_text'];?></textarea></td>
       
    </tr>

    <tr>
        <td>What different you would have done?</td>
        <td> <textarea class="form-control" rows="5" id="differencedonecomment" name="differencedonecomment" placeholder="Please Write Here" required><?php echo $feedbackdata[0]['different_done_you'];?></textarea></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td> <textarea class="form-control" rows="5" id="otherfeedbackcomment" name="otherfeedbackcomment" placeholder="Feedback" required><?php echo $feedbackdata[0]['any_other_feedback']; ?></textarea></td>
    </tr>
    <tr>
