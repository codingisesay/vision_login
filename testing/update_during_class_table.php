...
?>
            ...
            $query = "INSERT INTO issue_during_testing_remark (issue_id,issue_start_time,issue_end_time,observation,time_lost_during_class,checklist_id) VALUES ('$selected_issue','$issue_start_time','$issue_end','$issue_detail_remark','$lost_time','$checklist_id')";
