...
for($dataDate = 0; $dataDate < $dataForBatchWiseCount; $dataDate++){
    ...
    { label: "<?php   $orgDate = "$datesArray[$dates]";  echo $newDate = date("d/m", strtotime($orgDate));   ?>",  y: <?php echo $dataForBatchWise[$dataDate]['response']; ?>, indexLabel : "<?php echo $dataForBatchWise[$dataDate]['response']; ?>"},
