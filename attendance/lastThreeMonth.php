...
<li class="batchsearch filter-item items" data-filter="<?php echo  $batchSevenDay; ?>" data-value="<?php echo  $batchSevenDay; ?>"> <?php echo $batchSevenDay; ?> </li>
<?php
}
?>
...
<div class="row">
<div class="col-sm-2">
<button type="button" id="submitdd" class="btn btn-primary" data-value="<?php echo  $batchSevenDay; ?>">Submit</button>
</div>
</div>
</form>
<div class="row">
...
alert("Please Fill date and batch!!");
}
